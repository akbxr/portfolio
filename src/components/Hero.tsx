  ...
  return (
    <section className="h-dvh w-dvw overflow-hidden relative">
      ...
      <div className="relative h-full w-full">
        <div className="flex items-center justify-center flex-col h-full pb-10 px-8">
          {/* <Transition> */}
          {/*   <Image */}
          ...
          <div className="py-6 flex items-center flex-wrap">
            <h2 className="md:text-7xl text-3xl font-bold overflow-hidden">
              <SlideIn className="pr-8">Hello! </SlideIn>
              <SlideIn> I&apos;m {about.name}</SlideIn>
            </h2>
            <h1 className="md:text-7xl text-2xl overflow-hidden">
